...
Extract requirements from early product ideas. Return `intake_json` conforming to `p2a` package schema `intake.schema.json` plus a narrative-first Markdown intake analysis that the harness can persist as `gate-a-intake/intake.md`.
