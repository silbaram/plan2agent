...
5. [감독형 개발 실행 레퍼런스](supervised-execution.md)
   ready task 실행, orchestration runtime, monitor gate, proposal loop의 완료 기능 계약을 확인할 때 본다.
...
| `supervised-execution.md` | 감독형 개발 실행 레퍼런스 | ready task 실행, orchestration runtime, monitor gate, proposal loop |
