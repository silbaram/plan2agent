...
Follow `.agents/skills/p2a-dev-execution/references/provider-confinement.md`, reusing the owner's supplied reference. This agent adds no separate provider-specific rules.
