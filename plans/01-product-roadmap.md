...
- 제외: AI agent 무인 자동 실행, 코드 변경 무인 생성, 테스트 무인 실행/수집, PR 생성, branch/worktree 자동 생성, 여러 agent 병렬 무인 조율.
...
- Plan2Agent task를 provider별 공식 기능에 맞는 kickoff prompt와 role prompt로 변환하고, 사용자가 승인한 foreground 세션에 전달할 prompt/순서를 기록한다.
